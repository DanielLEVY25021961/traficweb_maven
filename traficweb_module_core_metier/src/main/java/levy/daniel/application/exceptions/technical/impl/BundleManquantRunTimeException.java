 ...
 * Hérite de AbstractRunTimeTechnicalException.<br/>
 ...
 *
 */
public class BundleManquantRunTimeException 
					extends AbstractRunTimeTechnicalException {
	...
	private static final Log LOG = LogFactory
			.getLog(BundleManquantRunTimeException.class);
	 ...
	 */
	public BundleManquantRunTimeException() {
		super();
	 ...
	 */
	public BundleManquantRunTimeException(final String pMessage) {
		super(pMessage);
	 ...
	 */
	public BundleManquantRunTimeException(final Throwable pCause) {
		super(pCause);
	} // Fin de CONSTRUCTEUR BundleManquantException(
