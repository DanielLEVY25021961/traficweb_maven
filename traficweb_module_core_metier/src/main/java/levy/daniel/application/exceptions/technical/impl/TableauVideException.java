 ...
 *
 */
public class TableauVideException extends AbstractTechnicalException {
	...
	/**
	 * method CONSTRUCTEUR TableauVideException() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * Permet de construire une TableauVideException
	 * sans message ni propagation d'exception cause.<br/>
	 *
	 */
	public TableauVideException() {
		super();
	} // Fin de TableauVideException().____________________________________
	


	/**
	 * method CONSTRUCTEUR TableauVideException(String pMessage) :<br/>
	 ...
	 */
	public TableauVideException(final String pMessage) {
		super(pMessage);
	} // Fin de CONSTRUCTEUR TableauVideException(
	// String pMessage).___________________________________________________
	
	
	
	/**
	 * method CONSTRUCTEUR TableauVideException(Throwable pCause) :<br/>
	 * Constructeur d'arité 1.<br/>
	 * Permet de construire une TableauVideException
	 ...
	 */
	public TableauVideException(final Throwable pCause) {
		super(pCause);
	} // Fin de CONSTRUCTEUR TableauVideException(
	...
	/**
	 * method CONSTRUCTEUR TableauVideException(
	 * String pMessage
	 * , Throwable pCause) :<br/>
...
} // FIn DE LA CLASSE TableauVideException.----------------------------------
