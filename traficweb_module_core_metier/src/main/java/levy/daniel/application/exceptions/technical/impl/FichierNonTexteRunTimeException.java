...
/**
 * class FichierNonTexteRunTimeException :<br/>
 ...
 * un fichier ne contient pas exclusivement des caractères "humains" 
 * (compris dans le Charset windows-1252).<br/>
 * <br/>
 *
 ...
 *
 */
public class FichierNonTexteRunTimeException extends
	...
	private static final Log LOG = LogFactory
			.getLog(FichierNonTexteRunTimeException.class);
	 ...
	 *
	 */
	public FichierNonTexteRunTimeException() {
		super();
	 ...
	 */
	public FichierNonTexteRunTimeException(final String pMessage) {
		super(pMessage);
	 ...
	 */
	public FichierNonTexteRunTimeException(final Throwable pCause) {
		super(pCause);
	} // Fin de CONSTRUCTEUR CleManquanteRunTimeException(
