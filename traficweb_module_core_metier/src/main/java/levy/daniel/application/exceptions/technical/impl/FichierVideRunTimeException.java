...
import levy.daniel.application.exceptions.technical.AbstractRunTimeTechnicalException;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

/**
 * class FichierVideRunTimeException :<br/>
 ...
 *
 */
public class FichierVideRunTimeException extends
	...
	private static final Log LOG = LogFactory
			.getLog(FichierVideRunTimeException.class);
	...
	/**
	 * method CONSTRUCTEUR FichierVideRunTimeException() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * Permet de construire une FichierVideRunTimeException
	 * sans message ni propagation d'exception cause.<br/>
	 *
	 */
	public FichierVideRunTimeException() {
		super();
	} // Fin de FichierVideRunTimeException()._____________________________
	


	/**
	 * method CONSTRUCTEUR FichierVideRunTimeException(
	 * String pMessage) :<br/>
	 ...
	 */
	public FichierVideRunTimeException(final String pMessage) {
		super(pMessage);
	} // Fin de CONSTRUCTEUR FichierVideRunTimeException(
	 ...
	 */
	public FichierVideRunTimeException(final Throwable pCause) {
		super(pCause);
	} // Fin de CONSTRUCTEUR FichierVideRunTimeException(
...
} // FIN DE LA CLASSE FichierVideRunTimeException.---------------------------
