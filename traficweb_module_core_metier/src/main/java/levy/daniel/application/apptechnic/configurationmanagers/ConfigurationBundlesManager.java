...
public final class ConfigurationBundlesManager {
	 ...
	 * <ul>
	 * <li>configuration_ressources_parametrables_fr_FR.properties.</li>
	 * <li>Contient les chemins vers les fichiers <b>EXTERNES 
	 * PARAMETRABLES PAR LA MOA</b>
	 * (donc, hors classpath) de l'application.</li>
	 * <li>encapsule racine_binaires/configuration_ressources_
	 * parametrables.properties.</li>
	 * </ul>
	 */
	 ...
	 * <ul>
	 * <li>Fournit un <b>singleton de bundleRessourcesExternes</b> 
	 * (configuration_ressources_parametrables.properties).</li>
	 * <li>bundleRessourcesExternes encapsule 
	 * racine_binaires/
	 * configuration_ressources_parametrables.properties qui 
	 * est un fichier <b>INTERNE</b> paramétrable uniquement 
	 * par le centre serveur</li>
	 * <li>bundleRessourcesExternes contient les chemins vers les fichiers <b>EXTERNES 
	 * PARAMETRABLES PAR LA MOA</b> (donc, hors classpath)
	 * comme les nomenclatures, les descriptions de fichiers, ....</li>
	 * <br/>
	 * - retourne null, LOG.FATAL et rapporte 
	 * si le properties est introuvable.<br/>
	 * <br/>
	...
	public static ResourceBundle getBundleRessourcesExternes() {
		...
		synchronized (ConfigurationRessourcesManager.class) {
			...
			} // Fin de if (bundleRessourcesExternes == null)._________________
