...
public final class ConfigurationNomenclaturesDarwinManager {
	 ...
	 */
	public static String getNomNomenclatureDarwinTypeComptage() {
	 ...
	 * @throws FichierVideRunTimeException si pFile est vide.<br/>
	 */
	public static File getFichierNomenclatureDarwinTypeComptageUtf8() {
	 ...
	 */
	public static String getNomNomenclatureDarwinClassementRoute() {
	 ...
	 * @throws FichierVideRunTimeException si pFile est vide.<br/>
	 */
	public static File getFichierNomenclatureDarwinClassementRouteUtf8() {
